...
import "./interface/IPlanetTreasury.sol";
import "./interface/IPlanetToken.sol";
...
contract Ecliptic is EclipticBase, SupportsInterfaceWithLookup, ERC721Metadata {
    ...
    // tokenTreasury: address of the token treasury contract
    //
    IPlanetTreasury public tokenTreasury;

    // planetToken: address of the planet token contract
    //
